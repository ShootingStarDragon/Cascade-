...
Func Example()
	; Create GUI
	Local $hGui = GUICreate( "Item and subitem checkboxes", 450, 200 )
	...
	For $i = 0 To $iItems - 1
		...
		_GUICtrlListView_AddSubItem( $hListView, $i, $i & "/Column 4", 3, 0 ) ; Unchecked checkbox in column 4
		_GUICtrlListView_SetItemImage( $hListView, $i, 0 )                    ; Unchecked checkbox for item
	Next
