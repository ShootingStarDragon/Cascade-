...
; Column 0 & 2 editable - simple text not selected on open
_GUIListViewEx_SetEditStatus($iLV_Left_Index, "0;2")

; Set header data for edit - Col 0 uses an edit; Col 1 is not editable as column itself is not editable; Col 2 uses a combo
