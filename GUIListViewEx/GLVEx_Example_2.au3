...
; Column 0 editable with readonly combo
_GUIListViewEx_SetEditStatus($iLV_Left_Index, 0, 2, "Fred|Dick|Harry with a very long name that will not fit in the column", True)
; Set combo dropdown width - use my StringSize UDF to get the correct value
Local $aWidth[1] = [320]
_GUIListViewEx_EditWidth($iLV_Left_Index, $aWidth)
; Initialise tooltip to display 0 column item content for 2 secs when clicked
_GUIListViewEx_ToolTipInit($iLV_Left_Index, "0", 2000)
